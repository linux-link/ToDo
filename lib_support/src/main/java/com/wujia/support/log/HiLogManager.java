    ...
    public static HiLogManager getInstance() {
        if (instance == null){
            synchronized (HiLogManager.class){
                instance = new HiLogManager(new HiLogConfig() {
                    @Override
                ...
                },new HiLogPrinter[]{new HiConsolePrinter(),HiFilePrinter.getInstance(
                        AppGlobal.getApplication().getCacheDir().getAbsolutePath(),0)});
            }
        }
        return instance;
    }
